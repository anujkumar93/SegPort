...
if (v1_layer_param.has_seg_accuracy_param()) {
    layer_param->mutable_seg_accuracy_param()->CopyFrom(
        v1_layer_param.seg_accuracy_param());
  }
  ...
  if (v1_layer_param.has_convolution_param()) {
   ...
   if (v1_layer_param.has_bilinearupsample_param()) {
    layer_param->mutable_bilinearupsample_param()->CopyFrom(
        v1_layer_param.bilinearupsample_param());
  }
...
const char* UpgradeV1LayerType(const V1LayerParameter_LayerType type) {
  ...
  case V1LayerParameter_LayerType_CONVOLUTION:
    return "Convolution";
  case V1LayerParameter_LayerType_BILINEARUPSAMPLE:
    return "Bilinearupsample";
  case V1LayerParameter_LayerType_CROPNEW:
    return "Cropnew";
  ...
  case V1LayerParameter_LayerType_IMAGE_SEG_DATA:
    return "ImageSegData";
  case V1LayerParameter_LayerType_IMAGE_MAT:
    return "ImageMat";
